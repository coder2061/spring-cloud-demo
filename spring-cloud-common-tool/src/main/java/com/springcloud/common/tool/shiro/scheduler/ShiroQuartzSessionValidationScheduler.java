package com.springcloud.common.tool.shiro.scheduler;
...
/**
 * 自定义 Quartz 会话验证调度器，用于定期的验证会话是否已过期，如果过期将停止会话
 * <p>
 * shiro-quartz中的实现是针对quartz1.6.1版本的实现（详细源码请查看QuartzSessionValidationScheduler），在quartz2.3.0中，SimppleTrigger为接口，所以无法实例化
 * <p>
